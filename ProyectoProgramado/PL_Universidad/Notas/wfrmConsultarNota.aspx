<%@ Page Title="" Language="C#" MasterPageFile="~/MasterFormularios.Master" AutoEventWireup="true" CodeBehind="wfrmConsultarNota.aspx.cs" Inherits="PL_Universidad.Notas.wfrmConsultarNota" %>
            ...
            <td colspan="2">
                <asp:GridView ID="gridCalificaciones" runat="server" Width="656px" AutoGenerateColumns="False" OnRowCommand="gridCalificaciones_RowCommand" OnSelectedIndexChanged="gridCalificaciones_SelectedIndexChanged1">
                    <Columns>
                        ...
                        <asp:ButtonField ButtonType="Button" Text="Editar" CommandName="habilitar" />
                    </Columns>
                </asp:GridView>
            </td>
        </tr>     
