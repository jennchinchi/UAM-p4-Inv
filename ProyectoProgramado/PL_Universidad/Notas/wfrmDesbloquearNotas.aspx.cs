...
{
    public partial class wfrmDesbloquearNotas : System.Web.UI.Page
    {
        ...
        protected void gridCalificaciones_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (Calificacion.Desbloquear(calificaciones[id].Id)  || !User.IsInRole("Director")) 
            {
                Button hb = gridCalificaciones.Rows[id].Cells[3].Controls[0] as Button;
                hb.Text = "Habilitado";
                hb.Enabled = false;
            }
            else
